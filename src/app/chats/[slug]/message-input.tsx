...
export default function MessageInput({ roomId }: { roomId: string }) {
    ...
    return (
        <div className="border-t flex p-2 gap-2">
            <AutosizeTextarea ref={inputRef as React.RefObject<AutosizeTextAreaRef>} autoFocus className="resize-none font-medium flex-1" value={message} onChange={(e) => setMessage(e.target.value)} disabled={isPending} placeholder="Mesaj..." />
